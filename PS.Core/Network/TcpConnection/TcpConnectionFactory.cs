...
using PS.Core.ProxySocket;

namespace PS.Core.Network.Tcp
{
    /// <summary>
...
retry:
        ...
        {
            static IAsyncResult beginConnect(IPAddress address, int port, AsyncCallback requestCallback, object state)
            {
