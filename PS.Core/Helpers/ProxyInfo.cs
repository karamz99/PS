...
namespace PS.Core.Helpers
{
    internal class ProxyInfo
    {
        ...
        internal static ProxyProtocolType? ParseProtocolType(string protocolTypeStr)
        {
            ...
            if (protocolTypeStr.Equals(Core.ProxyServer.UriSchemeHttp, StringComparison.InvariantCultureIgnoreCase))
            {
                protocolType = ProxyProtocolType.Http;
            }
            else if (protocolTypeStr.Equals(Core.ProxyServer.UriSchemeHttps,
